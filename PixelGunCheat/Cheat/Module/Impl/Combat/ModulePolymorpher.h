...
static BKCSliderInt __polymorph_type = BKCSliderInt("Polymorph Type", 0, 0, 4, "0 = Sheep, 1 = Beetle, 2 = Mutant, 3 = Cube, 4 = AncKnow");
...
public:
    ...
    void do_module(void* arg) override
    {
        ...
        set_float(arg, 0x300, 20.0f); // polymorphMaxHealth
    }
};
