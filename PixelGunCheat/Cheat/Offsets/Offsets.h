...
public:
    // Functions
    static inline uint64_t PlayerMoveCUpdate = 0x1BB40E0;
    static inline uint64_t WeaponSoundsUpdate = 0x812CE0;
    static inline uint64_t SetNextCriticalHit = 0x80BD70;
    static inline uint64_t MakeInvisibleForSeconds = 0x1B11700;
    // static inline uint64_t AddHealthFromWeaponOnline = 0x1AABE00;
    // static inline uint64_t AddAmmoFromWeaponOnline = 0x1AABC70;
    static inline uint64_t InfiniteGemClaim = 0x4BF5B0;
    // static inline uint64_t SetTimeScale = 0x436A560;
    static inline uint64_t RapidFire = 0x115A140;
    static inline uint64_t TextMeshGetText = 0x4496DF0;
    // static inline uint64_t Speed = 0x11383E0;
    // static inline uint64_t GetFov = 0x433C5C0;
    // static inline uint64_t SetFov = 0x433CEE0;
    static inline uint64_t BehaviourGetEnabled = 0x43ACBD0;
    static inline uint64_t OnPreRender = 0x43209F0;
    static inline uint64_t TextMeshGetColor = 0x4496B90;
    static inline uint64_t WorldToScreenPoint = 0x438C350;
    static inline uint64_t ComponentGetTransform = 0x43ADBF0;
    static inline uint64_t TransformGetRotation = 0x43C2B70;
    static inline uint64_t TransformGetPosition = 0x43C2A00;
    static inline uint64_t TransformLookAt = 0x43C0B70;
    static inline uint64_t PhysicsRayCast = 0x4420300;
    static inline uint64_t ObjectGetInstanceID = 0x43B5250;
    ...
    static inline uint64_t AddWeapon = 0x64EDF0;
    // static inline uint64_t PlayerGetWeaponManager = 0x1B10E60;
    static inline uint64_t ItemRecordGetShopId = 0x591F20;
    static inline uint64_t GetDamageMultiplier = 0x115EDC0;
    static inline uint64_t GetPlayerSpeed = 0x1160880;
    static inline uint64_t GetAmmoInClip = 0x1155F50;
    static inline uint64_t GetAmmo = 0x114F710;
    static inline uint64_t PlayerGetImmortality = 0x1B2AEA0;
    // static inline uint64_t AddWearItem = 0x6599B0;
    static inline uint64_t GiveWear = 0x2060FC0;
    static inline uint64_t GiveWeapon = 0x2061240;
    static inline uint64_t GivePets = 0x20576C0;
    static inline uint64_t AddGems = 0x2063440;
    static inline uint64_t AddCoins = 0x2064930;
